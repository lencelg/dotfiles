...
vim.pack.add({
    ...
    { src = 'https://github.com/mfussenegger/nvim-dap'},          -- dap
    { src = 'https://github.com/rcarriga/nvim-dap-ui'},           -- dap ui
    { src = 'https://github.com/folke/lazydev.nvim'},             -- lazydev for dap ui 
    { src = 'https://github.com/nvim-neotest/nvim-nio'},          --neovim-nio for dap
})
...
vim.keymap.set('n', '<leader>pf', ':Pick files<CR>', { desc = 'open file picker' })
vim.keymap.set('n', '<leader>ph', ':Pick help<CR>', { desc = 'open help picker' })
vim.keymap.set('n', '<leader>pg', ':Pick grep live<CR>', { desc = 'open grep live picker' })
vim.keymap.set('n', '<leader>pb', ':lua MiniPick.builtin.buffers()<CR>', { desc = 'open buffer picker' })
...
vim.keymap.set('n', '<Leader>dr', dap.repl.open, { desc = "打开调试控制台" })
