        ...
        window.onload=()=>{
            ...
            document.querySelectorAll(".hljs-button.signin").forEach((e) => {
                ...
                e.onclick = function (e) {
                    e.stopPropagation();
                    navigator.clipboard
                        .writeText(this.parentNode.children[0].innerText)
